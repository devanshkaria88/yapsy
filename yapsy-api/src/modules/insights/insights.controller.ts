...
export class InsightsController {
  ...
  @ApiResponse({ status: 200, description: 'Mood data returned successfully', type: [MoodDataPointDto] })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  getMoodData(
    @CurrentUser('id') userId: string,
    @Query() query: MoodQueryDto,
  ) {
  ...
  @ApiResponse({ status: 200, description: 'Themes returned successfully', type: [ThemeCountDto] })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  ...
  @Get('streaks')
  @ApiOperation({ summary: 'Get streak data (current, longest, total check-ins)' })
  @ApiResponse({ status: 200, description: 'Streaks returned successfully', type: StreaksResponseDto })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  ...
  @ApiResponse({ status: 200, description: 'Weekly insight returned successfully', type: MoodInsightResponseDto })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  ...
  @ApiResponse({ status: 200, description: 'Productivity stats returned successfully', type: ProductivityResponseDto })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Pro subscription required' })

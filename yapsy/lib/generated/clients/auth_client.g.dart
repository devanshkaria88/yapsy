...
class _AuthClient implements AuthClient {
  ...
  @override
  Future<MessageResponseDto> mobileAuthControllerLogout() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};

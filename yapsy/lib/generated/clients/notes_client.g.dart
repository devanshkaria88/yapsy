...
class _NotesClient implements NotesClient {
  _NotesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<GetApiV1MobileNotesResponse> mobileNotesControllerFindAll({
    ...
    final _options = _setStreamType<GetApiV1MobileNotesResponse>(
    ...
    late GetApiV1MobileNotesResponse _value;
    try {
      _value = GetApiV1MobileNotesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<NoteResponseDto> mobileNotesControllerCreate({
    ...
    final _options = _setStreamType<NoteResponseDto>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late NoteResponseDto _value;
    try {
      _value = NoteResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }

...
class _UsersClient implements UsersClient {
  ...
  @override
  Future<UserProfileResponseDto> mobileUsersControllerGetProfile() async {
  ...
  @override
  Future<MessageResponseDto> mobileUsersControllerDeleteAccount() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<MessageResponseDto> mobileUsersControllerUpdateFcmToken({
    ...
    final _options = _setStreamType<MessageResponseDto>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/mobile/users/me/fcm-token',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
